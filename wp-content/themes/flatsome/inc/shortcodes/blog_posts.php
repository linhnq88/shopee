...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		<div class="col <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
          ...
          <?php } ?>
					...
					<div class="meta-post-danhmuc"><span class="fa fa-folder"></span><span class="danh-muc-post"><?php
foreach((get_the_category()) as $category) { 
    echo $category->cat_name . ' '; 
} 
?></span><span class="fa fa-user"></span><span class="tac-gia"> </span> <?php echo get_the_author_meta('display_name', $author_id);?></div>
